    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if (fila >= 0) {
            ...
            if (confirmar == JOptionPane.YES_OPTION) {
                // Eliminar la cita del almacenamiento
                // Actualizar la tabla
            }
        } else {
    ...
    private void tbCitasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCitasMouseClicked
        if (evt.getClickCount() == 2) { // Detectar doble clic
            ...
            if (filaSeleccionada != -1) { // Verificar si se seleccionó una fila
                ...
                String motivo = tabla.getValueAt(filaSeleccionada, 1).toString();

                // Obtener el número de DNI del paciente
